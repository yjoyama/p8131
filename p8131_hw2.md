...
The residual deviance is 4.8285, with 15 degrees of freedom. This
indicates that the model explains some of the variability in the data,
as the residual deviance is lower than the null deviance.
